              ...
              child: AspectRatio(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      movie.releaseDate != null ? DateTime.parse(movie.releaseDate!).year.toString() : "-",
...
class _HomeMoviePageState extends State<HomeMoviePage> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildSubHeading(
                title: 'Popular',
                onTap: () => Navigator.pushNamed(context, RouteName.moviePopularPage),
              ),
              ...
              _buildSubHeading(
                title: 'Top Rated',
                onTap: () => Navigator.pushNamed(context, RouteName.movieTopRatedPage),
              ),
  ...
  void initState() {
    super.initState();
    Future.microtask(() => context.read<MovieNowPlayingBloc>().add(const OnFetchNowPlayingMovies()));
